...
/*
    _Models *teaPot2 = new _Models();
    _Models *teaPot3 = new _Models();
    _Models *teaPot4 = new _Models();
    _Models *teaPot5 = new _Models();
*/
...
GLint _Scene::initGL()
{
    ...
    /*
        teaPot2->initModel("images/tex2.jpg");
        teaPot3->initModel("images/tex2.jpg");
        teaPot4->initModel("images/tex2.jpg");
        teaPot5->initModel("images/tex2.jpg");
    */
    ...
    p->initParticles(0,0,-10, "images/tex.jpg");
...
GLint _Scene::drawScene()
{
    ...
    teaPot->drawModel();
    /*
        teaPot2->pos.x = std::srand(2) % 200;
        teaPot2->pos.z = (std::srand(2) % 200);
    teaPot2->moveModel();
    teaPot2->drawModel();
        teaPot3->pos.x = std::srand(3) % 200;
        teaPot3->pos.z = (std::srand(3) % 200);
    teaPot3->moveModel();
    teaPot3->drawModel();
        teaPot4->pos.x = std::srand(4) % 200;
        teaPot4->pos.z = (std::srand(4) % 200);
    teaPot4->moveModel();
    teaPot4->drawModel();
        teaPot5->pos.x = std::srand(5) % 200;
        teaPot5->pos.z = (std::srand(5) % 200);
    teaPot5->moveModel();
    teaPot5->drawModel();
    */
    ...
    */
    ...
    for(int i=0; i < 20; i++){
        ...
        if( hit->isSphereCollision(b[i].pos, mdl3D->pos, 0.2,0.3,0.4) )
        {
            mdl3D->actionTrigger = mdl3D->DEATH;
        }
			  ...
			  LPARAM lParam)
{
    ...
    case WM_LBUTTONDOWN: //Left Click
        snds->playSound("sounds/Sonic Jump Sound Effect.mp3");
